...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MeasureCategory.valid'
        db.add_column('lizard_measure_measurecategory', 'valid', self.gf('django.db.models.fields.NullBooleanField')(default=None, null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'MeasureCategory.valid'
        db.delete_column('lizard_measure_measurecategory', 'valid')
