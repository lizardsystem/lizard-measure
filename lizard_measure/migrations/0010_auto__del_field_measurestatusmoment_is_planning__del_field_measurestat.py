...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Measure.deleted'
        db.add_column('lizard_measure_measure', 'deleted', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Measure.deleted'
        db.delete_column('lizard_measure_measure', 'deleted')
