...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Score.target_2027'
        db.alter_column('lizard_measure_score', 'target_2027', self.gf('django.db.models.fields.CharField')(max_length=40, null=True))

        # Changing field 'Score.target_2015'
        db.alter_column('lizard_measure_score', 'target_2015', self.gf('django.db.models.fields.CharField')(max_length=40, null=True))


    def backwards(self, orm):
        
        # Changing field 'Score.target_2027'
        db.alter_column('lizard_measure_score', 'target_2027', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Score.target_2015'
        db.alter_column('lizard_measure_score', 'target_2015', self.gf('django.db.models.fields.FloatField')(null=True))
    ...
    models = {
        ...
        'lizard_area.area': {
            ...
            'dt_created': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 4, 16, 16, 49, 31, 167357)'}),
