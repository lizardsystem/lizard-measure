...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Organization.valid'
        db.add_column('lizard_measure_organization', 'valid', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'MeasureStatus.valid'
        db.add_column('lizard_measure_measurestatus', 'valid', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'Measure.valid'
        db.add_column('lizard_measure_measure', 'valid', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'Measure.land_costs'
        db.add_column('lizard_measure_measure', 'land_costs', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'MeasurePeriod.valid'
        db.add_column('lizard_measure_measureperiod', 'valid', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Organization.valid'
        db.delete_column('lizard_measure_organization', 'valid')

        # Deleting field 'MeasureStatus.valid'
        db.delete_column('lizard_measure_measurestatus', 'valid')

        # Deleting field 'Measure.valid'
        db.delete_column('lizard_measure_measure', 'valid')

        # Deleting field 'Measure.land_costs'
        db.delete_column('lizard_measure_measure', 'land_costs')

        # Deleting field 'MeasurePeriod.valid'
        db.delete_column('lizard_measure_measureperiod', 'valid')
    ...
    models = {
        ...
        'lizard_area.area': {
            ...
            'dt_created': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 2, 16, 16, 12, 47, 575089)'}),
