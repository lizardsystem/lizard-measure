...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('lizard_measure_horizontalbargraphitem', (
            ...
            ('time_step', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_fewsnorm.TimeStepCache'], null=True, blank=True)),
            ('qualifierset', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_fewsnorm.QualifierSetCache'], null=True, blank=True)),
            ('horizontal_bar_graph', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_measure.HorizontalBarGraph'])),
        ...
        db.send_create_signal('lizard_measure', ['HorizontalBarGraphItem'])
        ...
        db.create_table('lizard_measure_horizontalbargraph', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('lizard_measure', ['HorizontalBarGraph'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('lizard_measure_horizontalbargraphitem')
        ...
        db.delete_table('lizard_measure_horizontalbargraph')
    ...
    models = {
        ...
        'lizard_area.area': {
            ...
            'dt_created': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 2, 7, 14, 49, 26, 135091)'}),
        ...
        'lizard_measure.horizontalbargraphgoal': {
        ...
        'lizard_measure.horizontalbargraphitem': {
            ...
            'goals': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['lizard_measure.HorizontalBarGraphGoal']", 'null': 'True', 'blank': 'True'}),
