...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'WaterBody.water_type'
        db.alter_column('lizard_krw_waterbody', 'water_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_krw.KRWWaterType'], null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'WaterBody.water_type'
        raise RuntimeError("Cannot reverse this migration. 'WaterBody.water_type' and its values cannot be restored.")
