...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'HorizontalBarGraphItem.related_location'
        db.add_column('lizard_measure_horizontalbargraphitem', 'related_location', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'HorizontalBarGraphItem.related_location'
        db.delete_column('lizard_measure_horizontalbargraphitem', 'related_location')
    ...
    models = {
        ...
        'lizard_area.area': {
            ...
            'dt_created': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 4, 19, 11, 32, 11, 206258)'}),
