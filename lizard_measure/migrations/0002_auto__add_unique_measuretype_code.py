...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'MeasureType', fields ['code']
        db.create_unique('lizard_measure_measuretype', ['code'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'MeasureType', fields ['code']
        db.delete_unique('lizard_measure_measuretype', ['code'])
