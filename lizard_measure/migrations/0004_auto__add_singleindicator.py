...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('lizard_measure_singleindicator', (
            ...
            ('water_body', self.gf('django.db.models.fields.related.ForeignKey')(related_name='indicators', to=orm['lizard_measure.WaterBody'])),
        ))
        db.send_create_signal('lizard_measure', ['SingleIndicator'])


    def backwards(self, orm):
        
        # Deleting model 'SingleIndicator'
        db.delete_table('lizard_measure_singleindicator')
