...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('lizard_measure_alphascore', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('min_value', self.gf('django.db.models.fields.FloatField')(default=0.0)),
            ('max_value', self.gf('django.db.models.fields.FloatField')(default=1.0)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('color', self.gf('lizard_map.models.ColorField')(default='808080', max_length=8)),
        ))
        db.send_create_signal('lizard_measure', ['AlphaScore'])


    def backwards(self, orm):
        
        # Deleting model 'AlphaScore'
        db.delete_table('lizard_measure_alphascore')
