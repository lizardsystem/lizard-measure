...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('lizard_measure_organization', 'valid', self.gf('django.db.models.fields.NullBooleanField')(default=None, null=True, blank=True), keep_default=False)

        # Adding field 'MeasureStatus.valid'
        db.add_column('lizard_measure_measurestatus', 'valid', self.gf('django.db.models.fields.NullBooleanField')(default=None, null=True, blank=True), keep_default=False)

        # Adding field 'Measure.valid'
        db.add_column('lizard_measure_measure', 'valid', self.gf('django.db.models.fields.NullBooleanField')(default=True, null=True, blank=True), keep_default=False)

        # Adding field 'MeasurePeriod.valid'
        db.add_column('lizard_measure_measureperiod', 'valid', self.gf('django.db.models.fields.NullBooleanField')(default=None, null=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        'lizard_area.area': {
            ...
            'dt_created': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 2, 16, 16, 9, 40, 536839)'}),
