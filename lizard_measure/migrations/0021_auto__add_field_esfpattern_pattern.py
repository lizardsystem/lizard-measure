...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EsfPattern.pattern'
        db.add_column('lizard_measure_esfpattern', 'pattern', self.gf('django.db.models.fields.CharField')(default='----------------', max_length=16), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'EsfPattern.pattern'
        db.delete_column('lizard_measure_esfpattern', 'pattern')
    ...
    models = {
        ...
        'lizard_area.area': {
            ...
            'dt_created': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 2, 22, 13, 56, 46, 832141)'}),
