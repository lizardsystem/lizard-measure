...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'HorizontalBarGraphItem.location_postpend'
        db.add_column('lizard_measure_horizontalbargraphitem', 'location_postpend', self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'HorizontalBarGraphItem.location_postpend'
        db.delete_column('lizard_measure_horizontalbargraphitem', 'location_postpend')
    ...
    models = {
        ...
        'lizard_area.area': {
            ...
            'dt_created': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 7, 2, 9, 22, 50, 858117)'}),
        ...
        'lizard_measure.horizontalbargraphitem': {
            ...
            'location_postpend': ('django.db.models.fields.CharField', [], {'max_length': '40', 'null': 'True', 'blank': 'True'}),
