...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MeasurePeriod.start_date'
        db.alter_column('lizard_measure_measureperiod', 'start_date', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'MeasurePeriod.end_date'
        db.alter_column('lizard_measure_measureperiod', 'end_date', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Measure.value'
        db.alter_column('lizard_measure_measure', 'value', self.gf('django.db.models.fields.FloatField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'MeasurePeriod.start_date'
        db.alter_column('lizard_measure_measureperiod', 'start_date', self.gf('django.db.models.fields.DateField')(default=datetime.date(2016, 1, 1)))

        # Changing field 'MeasurePeriod.end_date'
        db.alter_column('lizard_measure_measureperiod', 'end_date', self.gf('django.db.models.fields.DateField')(default=datetime.date(2027, 1, 1)))

        # Changing field 'Measure.value'
        db.alter_column('lizard_measure_measure', 'value', self.gf('django.db.models.fields.FloatField')(default=0))
    ...
    models = {
        ...
        'lizard_area.area': {
            ...
            'dt_created': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 3, 22, 13, 18, 33, 262682)'}),
