...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Measure.owner'
        db.alter_column('lizard_krw_measure', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))


    def backwards(self, orm):
        
        # Changing field 'Measure.owner'
        db.alter_column('lizard_krw_measure', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']))
