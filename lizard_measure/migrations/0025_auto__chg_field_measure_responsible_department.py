...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Measure.responsible_department'
        db.alter_column('lizard_measure_measure', 'responsible_department', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))


    def backwards(self, orm):
        
        # Changing field 'Measure.responsible_department'
        db.alter_column('lizard_measure_measure', 'responsible_department', self.gf('django.db.models.fields.CharField')(default='unknown', max_length=256))
    ...
    models = {
        ...
        'lizard_area.area': {
            ...
            'dt_created': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 4, 17, 13, 38, 28, 351903)'}),
