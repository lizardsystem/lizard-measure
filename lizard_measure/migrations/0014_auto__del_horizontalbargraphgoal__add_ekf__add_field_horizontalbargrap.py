...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table('lizard_measure_horizontalbargraphgoal')

        # Manually removed some fields
        # # Adding model 'EKF'
        # db.create_table('lizard_measure_ekf', (
        #     ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        #     ('measure', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_measure.Measure'])),
        #     ('ekf', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        #     ('target', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
        #     ('positive', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
        #     ('negative', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
        # ))
        # db.send_create_signal('lizard_measure', ['EKF'])

        # Adding field 'HorizontalBarGraphItem.measuring_rod'
        db.add_column('lizard_measure_horizontalbargraphitem', 'measuring_rod', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_measure.MeasuringRod'], null=True, blank=True), keep_default=False)

        # Removing M2M table for field goals on 'HorizontalBarGraphItem'
        db.delete_table('lizard_measure_horizontalbargraphitem_goals')

        # # Adding field 'FundingOrganization.comment'
        # db.add_column('lizard_measure_fundingorganization', 'comment', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # # Adding field 'Measure.in_sgbp'
        # db.add_column('lizard_measure_measure', 'in_sgbp', self.gf('django.db.models.fields.NullBooleanField')(default=None, null=True, blank=True), keep_default=False)


    def backwards(self, orm):

        # Adding model 'HorizontalBarGraphGoal'
        db.create_table('lizard_measure_horizontalbargraphgoal', (
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')()),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('value', self.gf('django.db.models.fields.FloatField')()),
        ))
        db.send_create_signal('lizard_measure', ['HorizontalBarGraphGoal'])

        # # Deleting model 'EKF'
        # db.delete_table('lizard_measure_ekf')

        # Deleting field 'HorizontalBarGraphItem.measuring_rod'
        db.delete_column('lizard_measure_horizontalbargraphitem', 'measuring_rod_id')

        # Adding M2M table for field goals on 'HorizontalBarGraphItem'
        db.create_table('lizard_measure_horizontalbargraphitem_goals', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('horizontalbargraphitem', models.ForeignKey(orm['lizard_measure.horizontalbargraphitem'], null=False)),
            ('horizontalbargraphgoal', models.ForeignKey(orm['lizard_measure.horizontalbargraphgoal'], null=False))
        ))
        db.create_unique('lizard_measure_horizontalbargraphitem_goals', ['horizontalbargraphitem_id', 'horizontalbargraphgoal_id'])

        # # Deleting field 'FundingOrganization.comment'
        # db.delete_column('lizard_measure_fundingorganization', 'comment')

        # # Deleting field 'Measure.in_sgbp'
        # db.delete_column('lizard_measure_measure', 'in_sgbp')
    ...
    models = {
        ...
        'lizard_area.area': {
            ...
            'dt_created': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 2, 8, 15, 43, 13, 36456)'}),
        ...
        'lizard_measure.ekf': {
            'Meta': {'object_name': 'EKF'},
            'ekf': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'measure': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['lizard_measure.Measure']"}),
            'negative': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            'positive': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            'target': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'})
        },
        ...
        'lizard_measure.measure': {
            ...
            'valid': ('django.db.models.fields.NullBooleanField', [], {'default': 'True', 'null': 'True', 'blank': 'True'}),
