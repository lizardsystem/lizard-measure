...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MeasureType.unit'
        db.add_column('lizard_measure_measuretype', 'unit', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_measure.Unit'], null=True, blank=True), keep_default=False)
        ...
        db.delete_column('lizard_measure_measure', 'unit_id')


    def backwards(self, orm):
        
        # Deleting field 'MeasureType.unit'
        db.delete_column('lizard_measure_measuretype', 'unit_id')
        ...
        db.add_column('lizard_measure_measure', 'unit', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['lizard_measure.Unit']), keep_default=False)
    ...
    models = {
        ...
        'lizard_area.area': {
            ...
            'dt_created': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 6, 4, 14, 2, 43, 335266)'}),
        ...
        'lizard_measure.esfpattern': {
            'Meta': {'ordering': "['pattern', 'data_set']", 'object_name': 'EsfPattern'},
        ...
        'lizard_measure.horizontalbargraphitem': {
            ...
            'related_location': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
        ...
        'lizard_measure.measuretype': {
            ...
            'unit': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['lizard_measure.Unit']", 'null': 'True', 'blank': 'True'}),
            'valid': ('django.db.models.fields.NullBooleanField', [], {'default': 'None', 'null': 'True', 'blank': 'True'})
        },
        ...
        'lizard_measure.score': {
            ...
            'target_2015': ('django.db.models.fields.CharField', [], {'max_length': '40', 'null': 'True', 'blank': 'True'}),
            'target_2027': ('django.db.models.fields.CharField', [], {'max_length': '40', 'null': 'True', 'blank': 'True'})
        },
        'lizard_measure.steeringparameterfree': {
            'Meta': {'ordering': "('order',)", 'object_name': 'SteeringParameterFree'},
        ...
        'lizard_measure.steeringparameterpredefinedgraph': {
            'Meta': {'ordering': "('order',)", 'object_name': 'SteeringParameterPredefinedGraph'},
            'area': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['lizard_area.Area']"}),
