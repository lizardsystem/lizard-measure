...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Measure.read_only'
        db.add_column('lizard_measure_measure', 'read_only', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Measure.read_only'
        db.delete_column('lizard_measure_measure', 'read_only')
