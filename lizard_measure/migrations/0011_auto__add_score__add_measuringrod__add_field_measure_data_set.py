...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('lizard_measure_measuringrod', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('measuring_rod_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_measure.MeasuringRod'], null=True, blank=True)),
        ...
        # Adding field 'Measure.data_set'
        db.add_column('lizard_measure_measure', 'data_set', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_security.DataSet'], null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Measure.data_set'
        db.delete_column('lizard_measure_measure', 'data_set_id')
