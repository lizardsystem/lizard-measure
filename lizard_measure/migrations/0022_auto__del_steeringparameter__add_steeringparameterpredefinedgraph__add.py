...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SteeringParameterPredefinedGraph'
        db.create_table('lizard_measure_steeringparameterpredefinedgraph', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('area', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_area.Area'])),
            ('order', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('for_evaluation', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('predefined_graph', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_measure.PredefinedGraphSelection'])),
            ('area_of_predefined_graph', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['lizard_area.Area'])),
        ))
        db.send_create_signal('lizard_measure', ['SteeringParameterPredefinedGraph'])

        # Adding model 'PredefinedGraphSelection'
        db.create_table('lizard_measure_predefinedgraphselection', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ...
            ('for_area_type', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('valid', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('lizard_measure', ['PredefinedGraphSelection'])

        # Adding model 'SteeringParameterFree'
        db.create_table('lizard_measure_steeringparameterfree', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('area', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_area.Area'])),
            ('order', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('for_evaluation', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('parameter_code', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ...
            ('location_modulinstance_string', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('lizard_measure', ['SteeringParameterFree'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'SteeringParameterPredefinedGraph'
        db.delete_table('lizard_measure_steeringparameterpredefinedgraph')

        # Deleting model 'PredefinedGraphSelection'
        db.delete_table('lizard_measure_predefinedgraphselection')

        # Deleting model 'SteeringParameterFree'
        db.delete_table('lizard_measure_steeringparameterfree')
    ...
    models = {
        ...
        'lizard_area.area': {
            ...
            'dt_created': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 2, 23, 10, 19, 15, 742375)'}),
        ...
        'lizard_measure.esfpattern': {
            ...
            'data_set': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': "orm['lizard_security.DataSet']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'measure_types': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['lizard_measure.MeasureType']"}),
            'pattern': ('django.db.models.fields.CharField', [], {'default': "'----------------'", 'max_length': '16'}),
            'watertype_group': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': "orm['lizard_measure.WatertypeGroup']"})
        },
        ...
        'lizard_measure.predefinedgraphselection': {
            'Meta': {'object_name': 'PredefinedGraphSelection'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'for_area_type': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'lizard_measure.steeringparameterfree': {
            'Meta': {'object_name': 'SteeringParameterFree'},
            'area': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['lizard_area.Area']"}),
            'for_evaluation': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'has_target': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location_modulinstance_string': ('django.db.models.fields.TextField', [], {}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'order': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'parameter_code': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'target_value': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'})
        },
        'lizard_measure.steeringparameterpredefinedgraph': {
            'Meta': {'object_name': 'SteeringParameterPredefinedGraph'},
            'area': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['lizard_area.Area']"}),
            'area_of_predefined_graph': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': "orm['lizard_area.Area']"}),
            'for_evaluation': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'order': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'predefined_graph': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['lizard_measure.PredefinedGraphSelection']"})
        },
        'lizard_measure.unit': {
