...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('lizard_measure_measuretype', 'group', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MeasureType.group'
        db.delete_column('lizard_measure_measuretype', 'group')
