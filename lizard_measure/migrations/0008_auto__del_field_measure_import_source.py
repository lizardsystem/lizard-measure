...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Measure.import_source'
        db.delete_column('lizard_measure_measure', 'import_source')


    def backwards(self, orm):
        
        # Adding field 'Measure.import_source'
        db.add_column('lizard_measure_measure', 'import_source', self.gf('django.db.models.fields.CharField')(default=3, max_length=16), keep_default=False)
