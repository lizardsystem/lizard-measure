...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Measure.description'
        db.alter_column('lizard_measure_measure', 'description', self.gf('django.db.models.fields.TextField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Measure.description'
        db.alter_column('lizard_measure_measure', 'description', self.gf('django.db.models.fields.CharField')(max_length=512, null=True))
    ...
    models = {
        ...
        'lizard_area.area': {
            ...
            'dt_created': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 9, 19, 11, 56, 5, 164471)'}),
