...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'EsfLink'
        db.create_table('lizard_measure_esflink', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('measure', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_measure.Measure'])),
            ('esf', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('is_target_esf', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
        ...
        db.send_create_signal('lizard_measure', ['EsfLink'])

        # Adding unique constraint on 'EsfLink', fields ['measure', 'esf']
        db.create_unique('lizard_measure_esflink', ['measure_id', 'esf'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'EsfLink', fields ['measure', 'esf']
        db.delete_unique('lizard_measure_esflink', ['measure_id', 'esf'])
        ...
        # Deleting model 'EsfLink'
        db.delete_table('lizard_measure_esflink')
    ...
    models = {
        ...
        'lizard_area.area': {
            ...
            'dt_created': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 2, 10, 16, 28, 19, 205313)'}),
        ...
        'lizard_measure.esflink': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_target_esf': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
