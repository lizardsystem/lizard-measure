...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('lizard_krw_municipality', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal('lizard_krw', ['Municipality'])
        ...
        db.create_table('lizard_krw_province', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal('lizard_krw', ['Province'])

        # Adding field 'WaterBody.status'
        db.add_column('lizard_krw_waterbody', 'status', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'WaterBody.protected_area_reason'
        db.add_column('lizard_krw_waterbody', 'protected_area_reason', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'WaterBody.code'
        db.add_column('lizard_krw_waterbody', 'code', self.gf('django.db.models.fields.CharField')(max_length=80, null=True, blank=True), keep_default=False)

        # Adding field 'WaterBody.characteristics'
        db.add_column('lizard_krw_waterbody', 'characteristics', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'WaterBody.current_situation_chemicals'
        db.add_column('lizard_krw_waterbody', 'current_situation_chemicals', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'WaterBody.control_parameters'
        db.add_column('lizard_krw_waterbody', 'control_parameters', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding M2M table for field area on 'WaterBody'
        db.create_table('lizard_krw_waterbody_area', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('waterbody', models.ForeignKey(orm['lizard_krw.waterbody'], null=False)),
            ('area', models.ForeignKey(orm['lizard_krw.area'], null=False))
        ))
        db.create_unique('lizard_krw_waterbody_area', ['waterbody_id', 'area_id'])

        # Adding M2M table for field province on 'WaterBody'
        db.create_table('lizard_krw_waterbody_province', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('waterbody', models.ForeignKey(orm['lizard_krw.waterbody'], null=False)),
            ('province', models.ForeignKey(orm['lizard_krw.province'], null=False))
        ))
        db.create_unique('lizard_krw_waterbody_province', ['waterbody_id', 'province_id'])

        # Adding M2M table for field municipality on 'WaterBody'
        db.create_table('lizard_krw_waterbody_municipality', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('waterbody', models.ForeignKey(orm['lizard_krw.waterbody'], null=False)),
            ('municipality', models.ForeignKey(orm['lizard_krw.municipality'], null=False))
        ))
        db.create_unique('lizard_krw_waterbody_municipality', ['waterbody_id', 'municipality_id'])


    def backwards(self, orm):
        
        # Deleting model 'Municipality'
        db.delete_table('lizard_krw_municipality')

        # Deleting model 'Area'
        db.delete_table('lizard_krw_area')

        # Deleting model 'Province'
        db.delete_table('lizard_krw_province')

        # Deleting field 'WaterBody.status'
        db.delete_column('lizard_krw_waterbody', 'status')

        # Deleting field 'WaterBody.protected_area_reason'
        db.delete_column('lizard_krw_waterbody', 'protected_area_reason')

        # Deleting field 'WaterBody.code'
        db.delete_column('lizard_krw_waterbody', 'code')

        # Deleting field 'WaterBody.characteristics'
        db.delete_column('lizard_krw_waterbody', 'characteristics')

        # Deleting field 'WaterBody.current_situation_chemicals'
        db.delete_column('lizard_krw_waterbody', 'current_situation_chemicals')

        # Deleting field 'WaterBody.control_parameters'
        db.delete_column('lizard_krw_waterbody', 'control_parameters')

        # Removing M2M table for field area on 'WaterBody'
        db.delete_table('lizard_krw_waterbody_area')

        # Removing M2M table for field province on 'WaterBody'
        db.delete_table('lizard_krw_waterbody_province')

        # Removing M2M table for field municipality on 'WaterBody'
        db.delete_table('lizard_krw_waterbody_municipality')
