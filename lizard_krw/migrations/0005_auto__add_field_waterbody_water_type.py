...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'WaterBody.water_type'
        db.add_column('lizard_krw_waterbody', 'water_type', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['lizard_krw.KRWWaterType']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'WaterBody.water_type'
        db.delete_column('lizard_krw_waterbody', 'water_type_id')
