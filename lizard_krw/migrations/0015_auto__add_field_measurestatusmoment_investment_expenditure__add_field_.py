...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MeasureStatusMoment.investment_expenditure'
        db.add_column('lizard_krw_measurestatusmoment', 'investment_expenditure', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'MeasureStatusMoment.exploitation_expenditure'
        db.add_column('lizard_krw_measurestatusmoment', 'exploitation_expenditure', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MeasureStatusMoment.investment_expenditure'
        db.delete_column('lizard_krw_measurestatusmoment', 'investment_expenditure')

        # Deleting field 'MeasureStatusMoment.exploitation_expenditure'
        db.delete_column('lizard_krw_measurestatusmoment', 'exploitation_expenditure')
    ...
    models = {
        ...
        'lizard_krw.fundingorganization': {
            ...
            'organization_part': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['lizard_krw.OrganizationPart']", 'null': 'True', 'blank': 'True'})
        },
        ...
        'lizard_krw.measure': {
            ...
            'executive': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['lizard_krw.Executive']"}),
            'executive_part': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['lizard_krw.ExecutivePart']", 'null': 'True', 'blank': 'True'}),
