...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Score.alpha_score'
        db.delete_column('lizard_krw_score', 'alpha_score_id')

        # Adding field 'AlphaScore.min_value'
        db.add_column('lizard_krw_alphascore', 'min_value', self.gf('django.db.models.fields.FloatField')(default=0.0), keep_default=False)

        # Adding field 'AlphaScore.max_value'
        db.add_column('lizard_krw_alphascore', 'max_value', self.gf('django.db.models.fields.FloatField')(default=0.0), keep_default=False)

        # Renaming column for 'AlphaScore.color' to match new field type.
        db.rename_column('lizard_krw_alphascore', 'color_id', 'color')
        # Changing field 'AlphaScore.color'
    ...
    def backwards(self, orm):
        ...
        # Changing field 'MeasureStatus.color'
        db.alter_column('lizard_krw_measurestatus', 'color', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Adding field 'Score.alpha_score'
        db.add_column('lizard_krw_score', 'alpha_score', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['lizard_krw.AlphaScore']), keep_default=False)

        # Deleting field 'AlphaScore.min_value'
        db.delete_column('lizard_krw_alphascore', 'min_value')

        # Deleting field 'AlphaScore.max_value'
        db.delete_column('lizard_krw_alphascore', 'max_value')

        # Renaming column for 'AlphaScore.color' to match new field type.
        db.rename_column('lizard_krw_alphascore', 'color', 'color_id')
        # Changing field 'AlphaScore.color'
        db.alter_column('lizard_krw_alphascore', 'color_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_krw.Color']))

        # Adding field 'GoalScore.alpha_score'
        db.add_column('lizard_krw_goalscore', 'alpha_score', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['lizard_krw.AlphaScore']), keep_default=False)
