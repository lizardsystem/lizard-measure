...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'MeasureCollection.estimated_costs_total'
        db.delete_column('lizard_krw_measurecollection', 'estimated_costs_total')

        # Deleting field 'MeasureCollection.estimated_costs_internal'
        db.delete_column('lizard_krw_measurecollection', 'estimated_costs_internal')


    def backwards(self, orm):
        
        # Adding field 'MeasureCollection.estimated_costs_total'
        db.add_column('lizard_krw_measurecollection', 'estimated_costs_total', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'MeasureCollection.estimated_costs_internal'
        db.add_column('lizard_krw_measurecollection', 'estimated_costs_internal', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)
