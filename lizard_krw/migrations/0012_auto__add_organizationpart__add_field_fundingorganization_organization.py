...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('lizard_krw_organizationpart', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('organization', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_krw.Organization'])),
        ))
        db.send_create_signal('lizard_krw', ['OrganizationPart'])

        # Adding field 'FundingOrganization.organization_part'
        db.add_column('lizard_krw_fundingorganization', 'organization_part', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_krw.OrganizationPart'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'OrganizationPart'
        db.delete_table('lizard_krw_organizationpart')

        # Deleting field 'FundingOrganization.organization_part'
        db.delete_column('lizard_krw_fundingorganization', 'organization_part_id')
