...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('lizard_krw_measurecollection', (
            ...
            ('urgency', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_krw.Urgency'])),
            ...
            ('estimated_costs_total', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('estimated_costs_internal', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('need_co_funding', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('lizard_krw', ['MeasureCollection'])

        # Adding M2M table for field area on 'MeasureCollection'
        db.create_table('lizard_krw_measurecollection_area', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('measurecollection', models.ForeignKey(orm['lizard_krw.measurecollection'], null=False)),
            ('area', models.ForeignKey(orm['lizard_krw.area'], null=False))
        ))
        db.create_unique('lizard_krw_measurecollection_area', ['measurecollection_id', 'area_id'])

        # Adding model 'Department'
        db.create_table('lizard_krw_department', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('organization', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_krw.Organization'], null=True, blank=True)),
        ))
        db.send_create_signal('lizard_krw', ['Department'])

        # Adding model 'Urgency'
        db.create_table('lizard_krw_urgency', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('value', self.gf('django.db.models.fields.FloatField')()),
        ))
        db.send_create_signal('lizard_krw', ['Urgency'])


    def backwards(self, orm):
        
        # Deleting model 'MeasureCollection'
        db.delete_table('lizard_krw_measurecollection')

        # Removing M2M table for field area on 'MeasureCollection'
        db.delete_table('lizard_krw_measurecollection_area')

        # Deleting model 'Department'
        db.delete_table('lizard_krw_department')

        # Deleting model 'Urgency'
        db.delete_table('lizard_krw_urgency')
