...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('lizard_krw_executivepart', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('executive', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_krw.Executive'])),
        ))
        db.send_create_signal('lizard_krw', ['ExecutivePart'])

        # Adding field 'Measure.executive_part'
        db.add_column('lizard_krw_measure', 'executive_part', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_krw.ExecutivePart'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'ExecutivePart'
        db.delete_table('lizard_krw_executivepart')

        # Deleting field 'Measure.executive_part'
        db.delete_column('lizard_krw_measure', 'executive_part_id')
