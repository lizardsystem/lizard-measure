...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Measure.period'
        db.add_column('lizard_krw_measure', 'period', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['lizard_krw.MeasurePeriod']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Measure.period'
        db.delete_column('lizard_krw_measure', 'period_id')
    ...
    models = {
        ...
        'lizard_krw.measure': {
            ...
            'period': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['lizard_krw.MeasurePeriod']"}),
