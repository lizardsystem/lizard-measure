...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('lizard_krw_waterbodystatus', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=80)),
        ))
        db.send_create_signal('lizard_krw', ['WaterBodyStatus'])

        # Adding field 'WaterBody.status'
        db.add_column('lizard_krw_waterbody', 'status', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_krw.WaterBodyStatus'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'WaterBodyStatus'
        db.delete_table('lizard_krw_waterbodystatus')

        # Deleting field 'WaterBody.status'
        db.delete_column('lizard_krw_waterbody', 'status_id')
